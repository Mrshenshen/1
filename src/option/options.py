...
class options():
    def __init__(self):
        ...
        self._par.add_argument('--model_name', default='', type=str, help='experiment name')
        ...
        self._par.add_argument('--batch_size', type=int, default=32, help='batch size')
        ...
        self._par.add_argument('--lr', type=float, default=0.0005, help='initial learning rate for adam')
        ...
        self._par.add_argument('--GPU_id', type=str, default='4', help='choose GPU ID')
        ...
        self._par.add_argument('--dataroot', type=str, default='',  help='data root of the Data')
